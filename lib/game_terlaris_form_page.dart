...
class GameTerlarisFormPage extends StatefulWidget {
  const GameTerlarisFormPage({Key? key}) : super(key: key);

  @override
  _GameTerlarisFormPageState createState() => _GameTerlarisFormPageState();
}

class _GameTerlarisFormPageState extends State<GameTerlarisFormPage> {
  ...
  void _simpanForm(context) async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await supabase.from('game_terlaris').insert(data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tambah Game Terlaris'),
      ),
      body: Padding(
