...
class GameGratisFormPage extends StatefulWidget {
  const GameGratisFormPage({Key? key}) : super(key: key);

  @override
  _GameGratisFormPageState createState() => _GameGratisFormPageState();
}

class _GameGratisFormPageState extends State<GameGratisFormPage> {
  ...
  void _simpanForm(context) async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await supabase.from('game_gratis').insert(data);
